...
def AddMDefined(builder, mDefined):
    clz_Torappu_Undefinable_1_Torappu_SourceApplyWay_AddMDefined(builder, mDefined)
...
def AddMValue(builder, mValue):
    clz_Torappu_Undefinable_1_Torappu_SourceApplyWay_AddMValue(builder, mValue)

def clz_Torappu_Undefinable_1_Torappu_SourceApplyWay_End(builder):
    return builder.EndObject()

def End(builder):
    return clz_Torappu_Undefinable_1_Torappu_SourceApplyWay_End(builder)
