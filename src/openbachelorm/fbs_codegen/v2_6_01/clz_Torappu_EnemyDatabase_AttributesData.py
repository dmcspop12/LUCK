...
def AddEpBreakRecoverSpeed(builder, epBreakRecoverSpeed):
...
def AddAttractImmune(builder, attractImmune):
...
class clz_Torappu_EnemyDatabase_AttributesDataT(object):
    ...
    def __init__(self):
        ...
        self.epBreakRecoverSpeed = None  # type: Optional[clz_Torappu_Undefinable_1_System_Single_.clz_Torappu_Undefinable_1_System_Single_T]
        ...
        self.attractImmune = None  # type: Optional[clz_Torappu_Undefinable_1_System_Boolean_.clz_Torappu_Undefinable_1_System_Boolean_T]
    ...
    def _UnPack(self, clzTorappuEnemyDatabaseAttributesData):
        ...
        if clzTorappuEnemyDatabaseAttributesData.EpBreakRecoverSpeed() is not None:
            self.epBreakRecoverSpeed = clz_Torappu_Undefinable_1_System_Single_.clz_Torappu_Undefinable_1_System_Single_T.InitFromObj(clzTorappuEnemyDatabaseAttributesData.EpBreakRecoverSpeed())
        ...
        if clzTorappuEnemyDatabaseAttributesData.AttractImmune() is not None:
            self.attractImmune = clz_Torappu_Undefinable_1_System_Boolean_.clz_Torappu_Undefinable_1_System_Boolean_T.InitFromObj(clzTorappuEnemyDatabaseAttributesData.AttractImmune())
