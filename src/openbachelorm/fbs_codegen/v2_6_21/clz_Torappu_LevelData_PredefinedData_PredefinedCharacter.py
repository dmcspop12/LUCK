...
def AddShowSpIllust(builder, showSpIllust):
    clz_Torappu_LevelData_PredefinedData_PredefinedCharacterAddShowSpIllust(builder, showSpIllust)
...
def StartMasterInfosVector(builder, numElems):
    return clz_Torappu_LevelData_PredefinedData_PredefinedCharacterStartMasterInfosVector(builder, numElems)
        ...
        if not clzTorappuLevelDataPredefinedDataPredefinedCharacter.MasterInfosIsNone():
            ...
            for i in range(clzTorappuLevelDataPredefinedDataPredefinedCharacter.MasterInfosLength()):
                if clzTorappuLevelDataPredefinedDataPredefinedCharacter.MasterInfos(i) is None:
                    ...
                    clz_Torappu_CharacterData_MasterInfo_ = clz_Torappu_CharacterData_MasterInfo.clz_Torappu_CharacterData_MasterInfoT.InitFromObj(clzTorappuLevelDataPredefinedDataPredefinedCharacter.MasterInfos(i))
