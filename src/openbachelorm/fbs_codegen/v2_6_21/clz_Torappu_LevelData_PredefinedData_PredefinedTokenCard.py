...
def StartMasterInfosVector(builder, numElems):
    return clz_Torappu_LevelData_PredefinedData_PredefinedTokenCardStartMasterInfosVector(builder, numElems)
        ...
        if not clzTorappuLevelDataPredefinedDataPredefinedTokenCard.MasterInfosIsNone():
            ...
            for i in range(clzTorappuLevelDataPredefinedDataPredefinedTokenCard.MasterInfosLength()):
                if clzTorappuLevelDataPredefinedDataPredefinedTokenCard.MasterInfos(i) is None:
                    ...
                    clz_Torappu_CharacterData_MasterInfo_ = clz_Torappu_CharacterData_MasterInfo.clz_Torappu_CharacterData_MasterInfoT.InitFromObj(clzTorappuLevelDataPredefinedDataPredefinedTokenCard.MasterInfos(i))
